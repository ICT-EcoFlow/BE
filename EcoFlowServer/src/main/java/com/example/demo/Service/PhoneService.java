...
public class PhoneService {
    ...
    public SingleMessageSentResponse sendOne2(String to, String to2) {
    ...
    public SingleMessageSentResponse sendOne3(String to) {

        Message message = new Message();
        // 발신번호는 적절한 번호로 설정해야 합니다.
        message.setFrom("01076294088");
        message.setTo(to);
        message.setText("[ECO FLOW]\n예약이 완료되었습니다. 연락을 기다려주세요.");
    ...
    public SingleMessageSentResponse sendOne4(String to) {
